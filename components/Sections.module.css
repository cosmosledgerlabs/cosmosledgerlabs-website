...
.secBody {
  ...
  color: var(--text); line-height: 1.6; max-width: 640px;
}
...
.fundingTag {
  ...
  color:var(--cyan); letter-spacing:.14em; text-align:center;
  max-width:100%;
}
...
.cardText { font-family:'Share Tech Mono',monospace; font-size:clamp(13px,1.4vw,14px); color:var(--text); line-height:1.6; }
...
.archLayer::before { content:''; position:absolute; left:0; top:0; bottom:0; width:3px; background:linear-gradient(180deg,var(--cyan),rgba(0,100,200,.3)); }
.archNum { font-family:'Rajdhani',sans-serif; font-size:10px; font-weight:700; color:var(--cyan); min-width:28px; letter-spacing:.1em; flex-shrink:0; }
.archTitle { font-family:'Rajdhani',sans-serif; font-size:clamp(12px,1.5vw,14px); font-weight:700; color:var(--text); letter-spacing:.06em; flex:1; }
...
.wfDot { width:8px; height:8px; border-radius:50%; flex-shrink:0; background:var(--cyan); }
...
.wfLabel { font-family:'Rajdhani',sans-serif; font-size:clamp(14px,1.6vw,15px); font-weight:700; color:var(--text); letter-spacing:.05em; }
...
.secCardTitle { font-family:'Rajdhani',sans-serif; font-size:clamp(11px,1.4vw,13px); font-weight:700; color:var(--cyan); letter-spacing:.07em; }
.secCardText { font-family:'Share Tech Mono',monospace; font-size:clamp(13px,1.3vw,14px); color:var(--text); line-height:1.6; }

/* ===== ECOSYSTEM ===== */
.ecoText { font-family:'Share Tech Mono',monospace; font-size:clamp(15px,1.5vw,16px); color:var(--text); line-height:1.6; }
...
.rmItem::after { content:''; position:absolute; bottom:0; left:0; height:1px; background:linear-gradient(90deg,#001833,var(--cyan)); opacity:.5; }
...
.rmTitle1 { font-family:'Rajdhani',sans-serif; font-size:clamp(18px,2.5vw,22px); font-weight:700; color:var(--cyan); letter-spacing:.08em; }
.rmTitle2 { font-family:'Rajdhani',sans-serif; font-size:clamp(18px,2.5vw,22px); font-weight:700; color:var(--text); letter-spacing:.08em; }
...
.badgeCurrent { color:var(--cyan); background:rgba(0,160,240,.28); border:1.5px solid rgba(0,210,255,.6); }
.badgeNext    { color:var(--text); background:rgba(0,100,180,.32); border:1.5px solid rgba(0,170,230,.5); }
...
.dlBtn1 {
  ...
  color:var(--cyan); text-decoration:none; letter-spacing:.12em;
  white-space:nowrap;
...
.dlBtn2 {
  ...
  color:var(--text-muted); text-decoration:none; letter-spacing:.12em;
  white-space:nowrap;
}
...
.contactLocation { font-family:'Rajdhani',sans-serif; font-size:clamp(13px,1.6vw,15px); font-weight:600; color:var(--text-muted); margin-top:16px; letter-spacing:.08em; }
...
.inlineLink { color:var(--cyan); text-decoration:none; border-bottom:1px solid rgba(0,232,255,.4); transition:opacity .2s; }
...
.teamHead { font-family:'Rajdhani',sans-serif; font-weight:700; letter-spacing:.06em; color:var(--cyan); font-size:clamp(16px,2vw,20px); margin-bottom:10px; }

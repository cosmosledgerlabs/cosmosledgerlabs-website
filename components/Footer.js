...
export default function Footer() {
  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.social} style={{ flexWrap: 'wrap', gap: '14px' }}>
        <a className={styles.socialLink} href="https://wa.me/16476369568" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
        ...
        <a className={styles.socialLink} href="https://www.instagram.com/cosmosledgerlabs/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
        ...
        <a className={styles.socialLink} href="https://www.facebook.com/profile.php?id=61594352917370" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
        ...
        <a className={styles.socialLink} href="https://www.reddit.com/user/Pitiful_Medicine_957/" target="_blank" rel="noopener noreferrer" aria-label="Reddit">
        ...
        <a className={styles.socialLink} href="https://truthsocial.com/@CosmosLedgerlab" target="_blank" rel="noopener noreferrer" aria-label="Truth Social">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M4 3h16v4.2h-5.9V21H9.9V7.2H4z"/></svg>
        </a>
        <a className={styles.socialLink} href="mailto:info@cosmosledgerlabs.com" aria-label={isZh ? '電子郵件' : 'Email'}>

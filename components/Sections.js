...
export function Contact() {
  ...
  const CHANNELS = [
    ...
    { key: 'call', label: L({ en: 'Call', zh: '致電' }), color: '#34C759',
      href: 'tel:+16476369568',
      path: 'M6.6 10.8a15.6 15.6 0 0 0 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.2.4 2.4.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1C10.7 21 3 13.3 3 4c0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.4 0 .8-.2 1l-2.3 2.2Z' },
    ...
    { key: 'truth', label: 'Truth Social', color: '#5448EE',
        ...
        <div className="channelRow">
          {CHANNELS.map((c) => (
            <a
              ...
              title={c.label}
            >
              <span className="channelDot" style={{ background: c.color }}>

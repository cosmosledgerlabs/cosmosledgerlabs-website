...
export default function Demo() {
  ...
  useEffect(() => {
    ...
    const logData = [
      {c:'#00e8ff',cls:'hi',m:'Workflow signature validated on-chain'},
      {c:'#00cc88',cls:'ok',m:'Transaction batch confirmed — 3 txs'},
      {c:'#2288aa',cls:'',m:'Approval threshold 3/3 reached'},
      {c:'#00cc88',cls:'ok',m:'Settlement finalized on Solana'},
    ...
    const timers = [
      ...
      setInterval(() => {
        ...
        ;['blk','bb','sn'].forEach(id => { const e=$('_'+id); if(e) e.textContent = id==='bb'?'#'+bs:bs })
  ...
  return (
    <section className="section" id="demo">
      ...
      <h2 className="sec-title">Live Platform Demo</h2>
      <p className="sec-body">Real-time simulation of COSMOS Ledger Labs workflow automation infrastructure — approval coordination, transaction validation, execution monitoring and recovery systems.</p>
      ...
      <div ref={ref} className={styles.wrap}>
        ...
        <div className={styles.topbar}>
          ...
          <div className={styles.statuses}>
            <span className={styles.st}><span className={styles.dg}/><span style={{color:'#00ff88',fontSize:'9px'}}>SYSTEM ONLINE</span></span>
            <span className={styles.st}><span className={styles.db}/><span style={{color:'#00e8ff',fontSize:'9px'}}>SOLANA MAINNET</span></span>
          </div>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.card}>
            <div className={styles.ct}>// APPROVAL ENGINE</div>
            {[
              ...
              <div key={i} className={`${styles.ai} ${styles[a.cls]}`}>
                <div>
          ...
          {/* 交易监控 */}
          <div className={styles.card}>
            <div className={styles.ct}>// TRANSACTION MONITOR</div>
            <div id="dd_txlist">
              {[
          ...
          {/* 执行流程 */}
          <div className={styles.card}>
            <div className={styles.ct}>// EXECUTION PIPELINE</div>
            <div className={styles.pipeline}>
              {[
                {n:'01',label:'Workflow Created & Signed',state:'done'},
                {n:'02',label:'Approval Gate — 3/3 Confirmed',state:'done'},
                {n:'03',label:'Queue Position Assigned',state:'done'},
                {n:'04',label:'On-Chain Validation',state:'active',badge:'LIVE'},
                {n:'05',label:'Transaction Submit',state:'wait'},
          ...
          {/* 监控Dashboard */}
          <div className={styles.card}>
            <div className={styles.ct}>// RECOVERY MONITOR & NETWORK</div>
            ...
            <div id="dd_log">
              <div className={styles.logitem}><span className={styles.ltime}>14:25:12</span><div className={styles.ldot} style={{background:'#00e8ff'}}/><span className={`${styles.ltext} ${styles.hi}`}>On-chain validation initiated for WF_003</span></div>
              ...
              <div className={styles.logitem}><span className={styles.ltime}>14:23:01</span><div className={styles.ldot} style={{background:'#00cc88'}}/><span className={`${styles.ltext} ${styles.ok}`}>TX_A1B2 settled on Solana mainnet</span></div>
            </div>
          </div>
        </div>
        ...
        <div className={styles.bb}>
          <span>NETWORK <span className={styles.bv}>SOLANA MAINNET</span></span>
